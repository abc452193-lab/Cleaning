...
import { Calendar, Phone, MessageCircle, Clock, ArrowRight, Sparkles, CheckCircle } from 'lucide-react';
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button 
                  variant="secondary"
                  size="lg" 
                  className="bg-white text-orange-600 hover:bg-gray-50 flex-1"
                >
                ...
                <Button 
                  variant="outline" 
                  size="lg"
                  className="border-white text-white hover:bg-white hover:text-orange-600 flex-1"
                >
